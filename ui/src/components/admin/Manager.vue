<template>
    <div>
        ...
        <el-breadcrumb-item>学生管理员列表</el-breadcrumb-item>
      </el-breadcrumb> -->
        <!-- 卡片视图区 -->
        <el-card>
            <el-row :gutter="10">
                ...
                <el-col :span="4">
                    <el-button type="primary" @click="addDialogVisible = true">添加学生管理员</el-button>
                </el-col>
            </el-row>
            <!-- 学生管理员列表 -->
            <!-- border边框   stripe隔行变色 -->
        ...
        <!-- 创建新学生管理员对话框 -->
        <el-dialog title="添加学生管理员" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
            <!-- 内容主体区域 -->
        ...
        <el-dialog title="修改学生管理员信息" :visible.sync="editDialogVisible" width="50%" @colse="editDialogClosed">
            <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="70px">
                <!-- 学生管理员名 -->
                <el-form-item label="学生管理员名" prop="username">
...
export default {
    data() {
        return {
            ...
            addFormRules: {
                username: [
                    { required: true, message: "请输入学生管理员名", trigger: "blur" },

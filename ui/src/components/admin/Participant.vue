<template>
    <div>
        ...
        <el-card>
            <el-row :gutter="10">
                <el-col :span="4">
                    <el-select v-model="queryInfo.department" placeholder="请选择参赛方式">
                ...
                <el-col :span="6">
                    <!-- 搜索添加 -->
                    <el-input placeholder="请输入赛事名称" v-model="queryInfo.id" clearable @clear="getUserList">
                    </el-input>
                </el-col>
                <el-col :span="2">
            ...
            <el-table :data="userlist" :header-cell-style="{ 'text-align': 'center' }"
                ...
                <el-table-column label="赛事名称" width="170" prop="" alin></el-table-column>
                <el-table-column label="参赛方式" width="90" prop=""></el-table-column>
                <el-table-column label="学号" width="170" prop=""></el-table-column>
                ...
                <el-table-column label="审批" width="60" prop=""></el-table-column>
                <el-table-column label="报名表" width="60" prop=""></el-table-column>
